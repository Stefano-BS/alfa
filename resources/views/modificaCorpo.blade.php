            ...
            <div class="panel-body">
                <div class="col-md-10 col-md-offset-1 col-xs-12">
                    <form id="mod-obbiettivo" action="" method="post" class="form-horizontal">
                        ...
                        <div class="form-group row"><label for="nome" class="col-sm-4 col-form-label">Nome: </label><div class="col-sm-8">
                            <input type="text" name="nome" id="nome" class="form-control" value="{{$corpo->Nome}}"></div></div>
                        <div class="form-group row"><label for="data" class="col-sm-4 col-form-label">Data: </label><div class="col-sm-8">
                            <input type="text" name="data" id="data" class="form-control" value="{{ $corpo->Data}}"></div></div>
                        ...
                        <div class="form-group row"><label for="materiale" class="col-sm-4 col-form-label"> Materiale: </label><div class="col-sm-8">
                            <input type="text" name="materiale" id="materiale" class="form-control" value="{{$corpo->Materiale}}"></div></div>
                        <div class="form-group row"><label for="risoluzione" class="col-sm-4 col-form-label">Risoluzione: </label><div class="col-sm-8">
                            <input type="text" name="risoluzione" id="risoluzione" class="form-control" value="{{$corpo->Risoluzione}}"></div></div>
                        <div class="form-group row"><label for="formato" class="col-sm-4 col-form-label">Formato: </label><div class="col-sm-8">
                            <input type="text" name="formato" id="formato" class="form-control" value="{{$corpo->Formato}}"></div></div>
                        <div class="form-group row"><label for="maxiso" class="col-sm-4 col-form-label">MaxISO: </label><div class="col-sm-8">
                            <input type="text" name="maxiso" id="maxiso" class="form-control" value="{{$corpo->MaxISO }}"></div></div>
                        <div class="form-group row"><label for="maxisoext" class="col-sm-4 col-form-label">MaxISOExt: </label><div class="col-sm-8">
                        ...
                        <div class="form-group row"><label for="schermo" class="col-sm-4 col-form-label">Schermo: </label><div class="col-sm-8">
                            <input type="text" name="schermo" id="schermo" class="form-control" value="{{$corpo->Schermo}}"></div></div>
                        <div class="form-group row"><label for="mirino" class="col-sm-4 col-form-label">Mirino: </label><div class="col-sm-8">
                        ...
                        <div class="form-group row"><label for="maxss" class="col-sm-4 col-form-label">MaxSS: </label><div class="col-sm-8">
                        ...
                        <div class="form-group row"><label for="peso" class="col-sm-4 col-form-label">Peso: </label><div class="col-sm-8">
    ...
    <div class="row">
        <div class="col-md-6 col-xs-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <label class="col-sm-12"><h4>Data presentazione: {{$corpo->Data}}</h4></label>
                    <label class="col-sm-12"><h4>Prezzo di lancio (MSRP): {{$corpo->MSRP}}$</h4></label>
                    <label class="col-sm-12"><h4>Materiale: {{$corpo->Materiale}}</h4></label>
                    <label class="col-sm-12"><h4>Risoluzione: {{$corpo->Risoluzione}}MP</h4></label>
                    <label class="col-sm-12"><h4>Formato sensore: {{$corpo->Formato}}</h4></label>
                    <label class="col-sm-12"><h4>ISO Massimo: {{$corpo->MaxISO}}</h4></label>
                    <label class='col-sm-12'><h4>ISO Estesi: {{$corpo->MaxISOExt}}</h4></label>
                    <label class="col-sm-12"><h4>Punti AF: {{$corpo->AF}}</h4></label>
                    <label class="col-sm-12"><h4>Punti schermo: {{$corpo->Schermo}}</h4></label>
                    <label class="col-sm-12"><h4>Punti mirino: {{$corpo->Mirino}}</h4></label>
                    <label class="col-sm-12"><h4>Tempo otturatore minimo: 1/{{$corpo->MaxSS}}s</h4></label>
                    <label class="col-sm-12"><h4>Raffica: {{$corpo->FPS}}fps</h4></label>
                    <label class="col-sm-12"><h4>Registra 4K: @if($corpo->QHD > 0) {{$corpo->QHD}}p @else <span class="label label-danger">✖</span> @endif </h4></label>
                    <label class="col-sm-12"><h4>Registra Full HD: {{$corpo->AF}}p</h4></label>
                    <label class="col-sm-12"><h4>Stabilizzazione: @if($corpo->OSS == 0) <span class="label label-danger">✖</span> @else <span class="label label-success">✔</span> @endif </h4></label>
                    ...
                    <label class="col-sm-12"><h4>Flash integrato: @if($corpo->Flash == 0) <span class="label label-danger">✖</span> @else <span class="label label-success">✔</span> @endif </h4></label>
                    <label class="col-sm-12"><h4>CIPA: {{$corpo->CIPA}}</h4></label>
                    <label class="col-sm-12"><h4>Peso: {{$corpo->Peso}}g</h4></label>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-xs-12">
